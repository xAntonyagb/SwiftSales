...
public class SQLiteDataHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE NOTAFISCAL (NR_NOTAFISCAL INTEGER(10) PRIMARY KEY, VL_NOTAFISCAL NUMERIC(10,2), DT_EMISSAO DATE, NR_CHAVEACESSO VARCHAR(44) UNIQUE, CD_VENDEDOR INTEGER(5), CD_CLIENTE INTEGER(5), CD_FORMAPAGTO VARCHAR(2))");
        sqLiteDatabase.execSQL("CREATE TABLE ITEMNF (NR_NOTAFISCAL INTEGER(10), CD_PRODUTO INTEGER(5), VL_TOTALITEM NUMERIC(10,2), VL_DESCONTO NUMERIC(10,2), VL_SUBTOTAL NUMERIC(10,2), QT_PRODUTO INTEGER(5), PRIMARY KEY (NR_NOTAFISCAL, CD_PRODUTO))");
