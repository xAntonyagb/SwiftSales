...
public class SQLiteDataHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE ITEMNF (NR_ITEM_NOTAFISCAL INTEGER(10), NR_NOTAFISCAL INTEGER(10), CD_PRODUTO INTEGER(5), VL_UNITITEM NUMERIC(10,2), VL_DESCONTO NUMERIC(10,2), VL_SUBTOTAL NUMERIC(10,2), QT_PRODUTO INTEGER(5), PRIMARY KEY (NR_NOTAFISCAL, CD_PRODUTO, NR_ITEM_NOTAFISCAL))");
